...
| 인트로        | Intro_animation  | public float StopTime;<br/><br/>    private SpriteRenderer spriteRenderer;<br/>    public Sprite[] sprites;<br/>    public Sprite sprites_2;<br/><br/>    public GameObject speech;<br/><br/>    public GameObject PanelName;<br/>    public InputField textName;<br/>    public static string text_CatName;<br/><br/>    public GameObject PanelSex;<br/>    //public Button button_male;<br/>    //public Button button_female;<br/>    public int sex_value;<br/><br/>    public GameObject PanelInfo;<br/>    public Text textCatInfo; | Start()<br />Update()<br />IEnumerator _changeLight()<br />PopSpeech()<br />StroySex()<br />_button_male()<br />_button_female()<br />PopInfo()<br />_button_Yes()<br />_button_No()<br /> | Image_speech<br />IntroManager                               | Panel_Name<br />Panel_Sex<br />Panel_Info                    |                              |
